...
if (builder.Environment.IsDevelopment())
{
    ...
    // YARP direct forwarding:供 DevProxyMiddleware 用 IHttpForwarder 轉發到 ng serve
    // (取代自寫 HttpClient proxy，內建 WebSocket / streaming / header 轉發)
...
if (app.Environment.IsDevelopment())
{
    // 啟用 WebSocket 支援：YARP IHttpForwarder 轉發 ng serve 的 HMR / live-reload WebSocket 仍需此 middleware
    app.UseWebSockets();
    app.UseDevProxy();
}
